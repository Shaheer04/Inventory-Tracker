...
from database import get_session, get_read_session, get_write_session
...
@audit_operation(action = "CREATE", resource_type= "Product")
def create_product(
    product: Product,
...
@audit_operation(action="UPDATE", resource_type ="Product")
def update_product(
    product_id: int,
